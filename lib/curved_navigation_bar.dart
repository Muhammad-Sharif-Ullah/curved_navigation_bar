...
final double _kDefaultNavBarHeight = Platform.isAndroid ? 75.0 : 100.0;
...
class CurvedNavigationBar extends StatefulWidget {
  ...
  CurvedNavigationBar({
    ...
    this.maxWidth,
        ...
        assert(0 <= height && height <= _kDefaultNavBarHeight),
            ...
            child: Container(
              ...
              child: ClipRect(
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    Positioned(
                      bottom: -(Platform.isAndroid ? 40 : 30) -
                          (_kDefaultNavBarHeight - widget.height),
                    ...
                    Positioned(
                      left: 0,
                      right: 0,
                      bottom: 0 - (_kDefaultNavBarHeight - widget.height),
                      child: CustomPaint(
                        size: Size(
